...
\begin{enumerate}
    ...
    Find the sum to $n$ terms of the series whose $n$th term is given by $5-2n$?
...
Let \( y(n) \) denote the \( n \)th term of the series without the unit step function:
...
This formula gives the sum of the series up to \( N \) terms.
