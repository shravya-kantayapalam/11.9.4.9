...
However, the expression we have is not a simple geometric series, so the process to find the Z-transform of \(y(n)\) might not yield a simple closed-form expression without further manipulation.
